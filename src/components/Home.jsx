    ...
    return (
        <div name="home" className="h-screen w-full bg-gradient-to-b from-black to-gray-800 text-white">
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
                <div>
                <h2 className="pt-24 text-4xl md:text-7xl font-bold text-white py-4">Welcome to my portfolio!</h2>                    
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex space-x-4">
                        <a href="https://github.com/DiwasMainali1" target="_blank" rel="noopener noreferrer" className="hover:scale-110 duration-300 bg-gray-800 text-white px-4 py-2 rounded-2xl flex items-center">
                        ...
                        <a href="https://www.linkedin.com/in/diwas-mainali/" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 duration-300 bg-gray-800 text-white px-4 py-2 rounded-2xl flex items-center">
                        <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
