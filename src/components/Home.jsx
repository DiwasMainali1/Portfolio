            ...
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
                ...
                <p className="text-gray-500 py-4 max-w-md">
                    ...
                    <div name="homeButtons" className="flex justify-center space-x-4 md:justify-start">
                        <a href="../assets/resume.pdf" download className="group hover:scale-110 duration-300 text-black w-fit px-5 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-gray-300 to-white">
                            Resume
                            <span className="px-1.5 group-hover:text-red-600 duration-300">                        
                                <IoMdDownload />
                            </span>
                        </a>
                        <a href="mailto:diwas.mainali1@gmail.com" className="group hover:scale-110 duration-300 text-black w-fit px-4 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-gray-300 to-white">
                            Contact Me
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a href="https://www.linkedin.com/in/diwas-mainali/" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 duration-300 bg-gray-800 text-white px-4 py-2 rounded-full flex items-center">
                        <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
